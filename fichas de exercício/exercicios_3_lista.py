...
for x in range(h):
    ...
    lista_n_reais.append(numero_real)
    lista_n_reais.sort()
...
for pessoa in lista_pessoas:
    print(
        f"Bem-vindo(a)! Olá, {nova_pessoa[0]}. Você tem {nova_pessoa[1]} anos, e mede {nova_pessoa [2]} cm")
...
if 10 >= escolha >= 1:
        print('tabuada do', escolha)
for multiplicador in range (1, 11):
    multiplicação = escolha * multiplicador
    print (escolha, '*', multiplicador, '=', multiplicação)
