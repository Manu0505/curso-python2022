...
global banco
banco = pd.read_csv("sistema_reclamacoes/banco.csv", sep=";")
...
def salvar():
    banco.to_csv("sistema_reclamacoes/banco.csv", sep=";", index=False)
...
Form, Window  = uic.loadUiType("sistema_reclamacoes/tela.ui")
